...
class MyGrammerVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MyGrammerParser#If.
    def visitIf(self, ctx:MyGrammerParser.IfContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MyGrammerParser#Loop.
    def visitLoop(self, ctx:MyGrammerParser.LoopContext):
        return self.visitChildren(ctx)
