...
class MyGrammerListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MyGrammerParser#If.
    def enterIf(self, ctx:MyGrammerParser.IfContext):
        pass

    # Exit a parse tree produced by MyGrammerParser#If.
    def exitIf(self, ctx:MyGrammerParser.IfContext):
        pass
    ...
    # Exit a parse tree produced by MyGrammerParser#Equal.
    def exitEqual(self, ctx:MyGrammerParser.EqualContext):
        pass
